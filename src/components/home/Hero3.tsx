...
export default function Hero() {
    return (
        <section className="relative isolate max-md:h-[90vh] h-screen overflow-hidden bg-background">
            ...
            <div className="flex h-full md:h-screen max-w-7xl w-full items-end justify-between px-4 py-18 md:px-4 mx-auto">
                <div className="grid w-full md:items-end gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
                    {/* Left content */}
                    <motion.div
