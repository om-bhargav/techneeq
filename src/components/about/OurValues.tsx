...
const values = [
    {
        ...
        description: "We say no to projects AI won't actually help.",
    ...
    return (
      ...
      ===================================================== */}
            <div className="hidden md:block">
                ...
                {/* HEADER - Normal flow (Non-sticky) */}
                <div className="py-5">
                    <Section.Header
                        label="Our Values"
                        title="Our core principles — shaping how we work and the value we deliver"
                        titleclassName="max-w-3xl"
                    />
                </div>

                {/* SCROLL AREA - Only the content and loader below are sticky */}
                <div ref={sectionRef} className="relative h-[400vh]">
                    <div className="sticky top-0 flex min-h-screen flex-col justify-center pb-20">
                        
                        {/* VALUE NAV (Progress Line / Loader) */}
                        <div className="relative border-y border-foreground/15">
                            ...
                            <motion.div
                                ...
                                animate={{
                                    // 0% for first, 100% for last, and calc() for the middle ones
                                    width: activeIndex === 0 
                                        ? "0%" 
                                        : activeIndex === values.length - 1 
                                            ? "100%" 
                                            : `calc(${(activeIndex / values.length) * 100}% + 2.5rem)`,
                                }}
                                transition={{
                                    duration: 0.45,
                                    ease: [0.22, 1, 0.36, 1],
                            ...
                            <motion.div
                                ...
                                animate={{
                                    // Matches the exact same logic as width
                                    left: activeIndex === 0 
                                        ? "0%" 
                                        : activeIndex === values.length - 1 
                                            ? "100%" 
